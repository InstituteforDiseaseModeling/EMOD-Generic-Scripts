...
def make_work():
  ...
  sbwi_obj = SingularityBuildWorkItem(name             = 'Build_EMOD_EXE_Fedora35',
                                      definition_file  = 'EMOD_EXE_Fedora35.def',
                                      force            = True)
  ...
  # Magic words
  cmd_line = 'singularity exec Assets/EMOD_EXE_Fedora35.sif cp -r /outputs/. .'
