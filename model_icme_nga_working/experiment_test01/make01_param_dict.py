...
param_dict['EXP_NAME']     = 'DemogExample-NGA_admin01'
...
param_dict['EXP_CONSTANT']['num_agents']           = 10000

# Number of simulated years
param_dict['EXP_CONSTANT']['num_years']            =    20

# Name of Nigerian state
# e.g., KANO, JIGAWA
param_dict['EXP_CONSTANT']['nga_state_name']       = 'LAGOS'
