...
def campaignBuilder():
  ...
  for brate_dict in gdata.brate_mult_list:
  ...
  # Add MCV1 RI
  mcv1_dat = np.loadtxt(os.path.join('Assets','data', 'COD_MCV1.csv'), delimiter=',')
  with open(os.path.join('Assets','data', 'COD_MCV1.json')) as fid01:
  ...
  # Add MCV SIAs
  with open(os.path.join('Assets','data','COD_MCV_SIA.json')) as fid01:
