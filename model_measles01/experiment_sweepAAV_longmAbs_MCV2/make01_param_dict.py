...
param_dict['EXP_NAME']     = 'Measles01-SweepAAV-longmAbs-MCV2'
...
maternal_duration = [90.0, 150.0, 180.0]
NRuns = 5
myparams = [i for i in itertools.product(MCV1Covs, MCV1Ages, maternal_duration, [i for i in range(NRuns)])]
