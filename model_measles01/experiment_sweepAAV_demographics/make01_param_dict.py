...
param_dict['EXP_NAME']     = 'Measles01-SweepAAV-demographics'
...
start_year = [2020, 2060]
NRuns = 5
myparams = [i for i in itertools.product(MCV1Covs, MCV1Ages, start_year, [i for i in range(NRuns)])]
...
param_dict['EXP_VARIABLE']['start_year']            =   [x[2] for x in myparams]
