...
param_dict['EXP_NAME']     = 'Measles01-DemogL2_big_LowR0'
...
# Infectivity
param_dict['EXP_VARIABLE']['R0']           = ( 5.0 + np.random.gamma(30.0, scale=0.133, size=NSIMS)).tolist()

# RI params
param_dict['EXP_VARIABLE']['MCV1']         =        np.random.choice(np.arange(0.2,1.01,0.04), size=NSIMS).tolist()
param_dict['EXP_VARIABLE']['MCV1_age']     = (365.0*np.random.choice(np.arange(3,19)/12,       size=NSIMS)).tolist()
