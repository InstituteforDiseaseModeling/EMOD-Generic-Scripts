...
def make_work():
  ...
  sbwi_obj = SingularityBuildWorkItem(name             = 'Build_EMOD_EXE_Fedora38',
                                      definition_file  = 'EMOD_EXE_Fedora38.def',
                                      force            = True)
  ...
  # Magic words
  cmd_line = 'singularity exec Assets/EMOD_EXE_Fedora38.sif cp -r /outputs/. .'
