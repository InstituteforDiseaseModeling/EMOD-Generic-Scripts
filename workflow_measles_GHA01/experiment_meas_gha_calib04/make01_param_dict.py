...
param_dict['EXP_NAME']     = 'MEAS-GHA-Calib04'
...
param_dict['EXP_VARIABLE']['log10_import_rate']    =  np.random.uniform(low= -1.5, high=  0.0, size=NSIMS).tolist()
param_dict['EXP_VARIABLE']['ind_variance_risk']    =  np.random.uniform(low=  0.4, high=  2.2, size=NSIMS).tolist()
param_dict['EXP_VARIABLE']['SIA_cover_GHA-2018']   =  np.random.uniform(low=  0.3, high=  0.7, size=NSIMS).tolist()
...
#param_dict['EXP_CONSTANT']['ind_variance_risk']    =     0.4
